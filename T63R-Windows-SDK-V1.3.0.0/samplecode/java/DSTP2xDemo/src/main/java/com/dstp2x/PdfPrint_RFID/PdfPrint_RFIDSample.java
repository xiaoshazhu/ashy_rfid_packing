package com.dstp2x.PdfPrint_RFID;
...
public class PdfPrint_RFIDSample {
    ...
    protected IntByReference szResultLength =new IntByReference(),iDevSize=new IntByReference(512),iDevNum=new IntByReference(),iPdfPageCount=new IntByReference(),iOutFileSize=new IntByReference(1024),iOutRfidSize=new IntByReference(128);
...
//    protected IntByReference pDevHdl=new IntByReference(),pPdfHdl=new IntByReference();//Used for 32 bit systems, 32 bit libraries
    ...
    protected void startWork(){
        ...
        //6.Write EPC and USER data with the type of ascii to page one
        ...
        //7.Print the first page of pdf and write and read the data of EPC and USER
...
//        dstp2xJnaLib.DSTP2x_SetPdfPrnMode(pPdfHdl.getValue(),2);
    ...
    public static void main(String[] args){
        PdfPrint_RFIDSample sample=new PdfPrint_RFIDSample();
        sample.startWork();
    }
}
