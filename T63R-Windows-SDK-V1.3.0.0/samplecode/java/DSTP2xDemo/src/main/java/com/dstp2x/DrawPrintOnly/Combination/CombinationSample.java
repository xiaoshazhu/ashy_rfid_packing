package com.dstp2x.DrawPrintOnly.Combination;
...
//    protected IntByReference pDevHdl=new IntByReference(),pLabelHdl=new IntByReference();//Used for 32 bit systems, 32 bit libraries
    ...
    protected void startWork(){
        ...
        //5.Combine draw content
        String imgStr="E:\\ReleasePackage\\DSTP2x-mpsdk-V1.1.0.0@Test3\\DSTP2x-Windows-SDK-V1.1.0.0\\1.1\\samplecode\\java\\DSTP2xDemo\\src\\main\\resources\\image.jpg";
        dstp2xJnaLib.DSTP2x_Lbl_DrawImage(pLabelHdl.getValue(), 0, 10, 40, 40, 1, 0, imgStr, imgStr.length());
        dstp2xJnaLib.DSTP2x_Lbl_DrawBarCode(pLabelHdl.getValue(), 0, 60, 40, 30, 20, "123456");
        dstp2xJnaLib.DSTP2x_LcDraw_SetTextFontName(pLabelHdl.getValue(), 1,"Arial");
        dstp2xJnaLib.DSTP2x_LcDraw_SetTextFontSize(pLabelHdl.getValue(),0,10);
        dstp2xJnaLib.DSTP2x_Lbl_DrawText(pLabelHdl.getValue(), 0, 0, 40, 20, "abcdef123456");
...
//        dstp2xJnaLib.DSTP2x_SetLcPrnMode(pLabelHdl.getValue(),2);
    ...
    public static void main(String[] args){
        CombinationSample sample=new CombinationSample();
        sample.startWork();
    }
}
