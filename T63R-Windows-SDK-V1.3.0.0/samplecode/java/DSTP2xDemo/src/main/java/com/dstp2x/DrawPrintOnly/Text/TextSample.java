package com.dstp2x.DrawPrintOnly.Text;
...
//    protected IntByReference pDevHdl=new IntByReference(),pLabelHdl=new IntByReference();//Used for 32 bit systems, 32 bit libraries
    ...
    protected void startWork(){
        ...
        //5.Draw text
        dstp2xJnaLib.DSTP2x_LcDraw_SetTextItalic(pLabelHdl.getValue(),0,1);
        dstp2xJnaLib.DSTP2x_LcDraw_SetTextFontName(pLabelHdl.getValue(), 0,"Arial");
        dstp2xJnaLib.DSTP2x_LcDraw_SetTextBold(pLabelHdl.getValue(),0,1);
        dstp2xJnaLib.DSTP2x_LcDraw_SetTextFontSize(pLabelHdl.getValue(),0,10);
        dstp2xJnaLib.DSTP2x_Lbl_DrawText(pLabelHdl.getValue(), 0,10,40,40,"abcdef123456");
