...
===============================================================================
使用方法：
1、双击运行sln项目文件（需安装Microsoft Visual Studio 2010）
2、编译运行示例程序
3、编译完成后,需要把SDK包根目录下的lib文件夹里的主动态库及相关依赖文件复制到程序生产目录下即可执行
===============================================================================
...
EN Description:
===============================================================================
Overview of C# Sample Code Catalog
===============================================================================
...
===============================================================================
usage method:
1. Double click to run the SLN project file (requires installation of Microsoft Visual Studio 2010)
2. Compile and run the sample program
3. After compilation, it is necessary to copy the active state library and related dependency files from the lib folder in the root directory of the SDK package to the production directory of the program for execution
===============================================================================