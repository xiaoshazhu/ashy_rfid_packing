...
namespace Rectangle
{
    class Program
    {
        ...
        [DllImport("../../../../../../lib/Win32/libDSThermal.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        public static extern UInt32 DSTP2x_LcDraw_SetRectangleRotation(LC_HDL ullLcHdl, Int32 nTemporary, Int32 nAngle, Int32 nAnchorPoint);

        [DllImport("../../../../../../lib/Win32/libDSThermal.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        public static extern UInt32 DSTP2x_Lbl_DrawRectangle(LC_HDL ullLcHdl, Double dbX, Double dbY, Double dbW, Double dbH, Int32 nLineWidth, Int32 nLineType, Int32 nIsFill);
        ...
        static void Main(string[] args)
        {
            ...
            //5.Rectangle
            uRet = DSTP2x_LcDraw_SetRectangleRotation(lc_prt, 0, 30, 0);
            if (uRet != 0)
            {
                Console.WriteLine("Setting rotate for Rectangle，error code:[" + uRet.ToString() + "]");
                goto SAMPLE_END;
            }

            uRet = DSTP2x_Lbl_DrawRectangle(lc_prt, 10, 10, 20, 20, 5, 0, 0);
            if (uRet != 0)
            {
                Console.WriteLine("draw Rectangle，error code:[" + uRet.ToString() + "]");
                goto SAMPLE_END;
            }
