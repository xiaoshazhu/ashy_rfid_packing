...
namespace Combination
{
    class Program
    {
        ...
        [DllImport("../../../../../../lib/Win32/libDSThermal.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        public static extern UInt32 DSTP2x_Lbl_DrawImage(LC_HDL ullLcHdl, Double dbX, Double dbY, Double dbW, Double dbH, Double dbScale, Int32 nImgDataType, string szImage, Int32 unImgDataSize);
        ...
        static void Main(string[] args)
        {
            ...
            //5.Draw image.
            String imgPath = "../../samplecode/CSharp/DrawPrintOnly/Combination/image.jpg";
            uRet = DSTP2x_Lbl_DrawImage(lc_prt, 0, 10, 40, 40, 1, 0, imgPath, imgPath.Length); //data must be utf-8
            if (uRet != 0)
            {
                Console.WriteLine("Draw image failed，error code:[" + uRet.ToString() + "]");
                goto SAMPLE_END;
            }

            //6.Draw bar code.
            uRet = DSTP2x_Lbl_DrawBarCode(lc_prt, 0, 60, 40, 30, 20, "123456"); //data must be utf-8
            if (uRet != 0)
            {
            ...
            //7.Set font name for text.
            uRet = DSTP2x_LcDraw_SetTextFontName(lc_prt, 0, "Arial"); //The font name must be utf-8
            if (uRet != 0)
            {
            ...
            //8.Draw text.
            uRet = DSTP2x_Lbl_DrawText(lc_prt, 0, 0, 40, 20, "abcdef123456"); //data must be utf-8
            if (uRet != 0)
            {
