...
namespace Text
{
    class Program
    {
        ...
        [DllImport("../../../../../../lib/Win32/libDSThermal.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        public static extern UInt32 DSTP2x_LcDraw_SetTextFontName(LC_HDL ullLcHdl, Int32 nTemporary, string szFontName);
        
        [DllImport("../../../../../../lib/Win32/libDSThermal.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        public static extern UInt32 DSTP2x_LcDraw_SetTextFontSize(LC_HDL ullLcHdl, Int32 nTemporary, Double dbFontSize);
        
        [DllImport("../../../../../../lib/Win32/libDSThermal.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        public static extern UInt32 DSTP2x_LcDraw_SetTextBold(LC_HDL ullLcHdl, Int32 nTemporary, Int32 nIsBold);
        
        [DllImport("../../../../../../lib/Win32/libDSThermal.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        public static extern UInt32 DSTP2x_LcDraw_SetTextItalic(LC_HDL ullLcHdl, Int32 nTemporary, Int32 nIsItalic);
        
        [DllImport("../../../../../../lib/Win32/libDSThermal.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        public static extern UInt32 DSTP2x_LcDraw_SetTextRotation(LC_HDL ullLcHdl, Int32 nTemporary, Int32 nAngle, Int32 nAnchorPoint);

        [DllImport("../../../../../../lib/Win32/libDSThermal.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        public static extern UInt32 DSTP2x_Lbl_DrawText(LC_HDL ullLcHdl, Double dbX, Double dbY, Double dbW, Double dbH, string szText);
        ...
        static void Main(string[] args)
        {
            ...
            //4.Create the label.
            uRet = DSTP2x_CreateLabelContext(50, 50, ref lc_prt);
            if (uRet != 0)
            {
            ...
            //Non essential interface. Set the italic of text.
            uRet = DSTP2x_LcDraw_SetTextItalic(lc_prt, 0, 1);
            if (uRet != 0)
            {
                Console.WriteLine("Setting whether to italicize text failed，error code:[" + uRet.ToString() + "]");
                goto SAMPLE_END;
            }

            //Non essential interface. Set the bold of text.
            uRet = DSTP2x_LcDraw_SetTextBold(lc_prt, 0, 1);
            if (uRet != 0)
            {
                Console.WriteLine("Setting whether to bold text failed，error code:[" + uRet.ToString() + "]");
                goto SAMPLE_END;
            }

            //Non essential interface. Set the text rotation.
            uRet = DSTP2x_LcDraw_SetTextRotation(lc_prt, 0, 0, 0);
            if (uRet != 0)
            {
                Console.WriteLine("Setting text rotation failed，error code:[" + uRet.ToString() + "]");
                goto SAMPLE_END;
            }

            //5.Set the font name of text.
            //string gbkString = "宋体";
            ...
            //string utf8String = Encoding.GetEncoding("GBK").GetString(utf8Bytes);
            uRet = DSTP2x_LcDraw_SetTextFontName(lc_prt, 0, "Arial" /*utf8String*/); //The font name must be utf-8
            if (uRet != 0)
            {
                Console.WriteLine("Failed to set text font，error code:[" + uRet.ToString() + "]");
                goto SAMPLE_END;
            }

            //Non essential interface. set the size of text.
            uRet = DSTP2x_LcDraw_SetTextFontSize(lc_prt, 0, 10);
            if (uRet != 0)
            {
                Console.WriteLine("Failed to set text size，error code:[" + uRet.ToString() + "]");
                goto SAMPLE_END;
            }

            //6.Draw text.
            uRet = DSTP2x_Lbl_DrawText(lc_prt, 0, 10, 40, 40, "abcdef123456"); //data must be utf-8
            if (uRet != 0)
            {
                Console.WriteLine("Draw text failed，error code:[" + uRet.ToString() + "]");
                goto SAMPLE_END;
            }
