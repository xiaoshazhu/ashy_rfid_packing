...
namespace PdfPrint_RFID
{
    class Program
    {
        ...
        [DllImport("../../../../../lib/Win32/libDSThermal.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        public static extern UInt32 DSTP2x_SetPdfRFIDData(PDF_HDL ullPdfHdl, Int32 nPageNo, Int32 nRfidRgnType, Int32 nRfidDataFmt, string pData, Int32 nDataSize);
        ...
        static void Main(string[] args)
        {
            ...
            String pdfPath = "../../samplecode/CSharp/PdfPrint_RFID/PDF.pdf";
            int pdfPagesCount = 0;
            ...
            //6.Write EPC data with the type of ascii to page one
            uRet = DSTP2x_SetPdfRFIDData(pdf_prt, 1, 1, 1, writeEPCData, writeEPCData.Length); 
            if (uRet != 0)
            {
            ...
            //Write USER data with the type of ascii to page one
            uRet = DSTP2x_SetPdfRFIDData(pdf_prt, 1, 2, 1, writeUSERData, writeUSERData.Length); 
            if (uRet != 0)
            {
            ...
            //7.Print the first page of pdf and write and read the data of EPC and USER and TID
            uRet = DSTP2x_PrintPdf(dev_prt, pdf_prt, 1, szOutFile, ref pOutFileSize, 7, szOutRFID, ref pOutRFIDSize);
            if (uRet != 0)
            {
