...
namespace ReadTid_PdfPrint_RFID
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            String pdfPath = "../../samplecode/CSharp/ReadTid_PdfPrint_RFID/PDF.pdf";
            int pdfPagesCount = 0;
            ...
            //8.Print the first page of pdf and write and read the data of EPC and USER and TID
