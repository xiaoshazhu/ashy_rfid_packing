...
int main(int argc, char *argv[])
{
...
#if defined(_MSC_VER)
	const char *sztemplatesFile = "../../../TemplatePrintOnly/template.dlt";
#else
	const char *sztemplatesFile = "./template.dlt";
#endif
	...
	//7.Print label templates
	uiRet = DSTP2x_PrintTmpl(devHdl, labelTempHdl, NULL, NULL, NULL, NULL);
	if (uiRet)
	{
