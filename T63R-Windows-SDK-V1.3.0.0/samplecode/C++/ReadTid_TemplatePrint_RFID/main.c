...
int main(int argc, char *argv[])
{
...
#if defined(_MSC_VER)
	const char *sztemplatesFile = "../../../ReadTid_TemplatePrint_RFID/templateRFID.dlt";
#else
	...
	//8.Read the tid first
	uiRet = DSTP2x_RFID_ReadData(devHdl, szTID, &iTIDSize, NULL, NULL, NULL, NULL);
	if (uiRet)
	{
	...
	//9.Print label templates and read RFID
