...
int main(int argc, char *argv[])
{
	...
	//5.Draw Line
	uiRet = DSTP2x_Lbl_DrawLine(labelHdl, 5, 5, 90, 15, 15, 0); //Solid line
	if(uiRet)
	{
		printf("DSTP2x_Lbl_DrawLine error, error code:%d\n", uiRet);
		goto end;
	}

	uiRet = DSTP2x_Lbl_DrawLine(labelHdl, 5, 25, 90, 35, 15, 1); //Dashed line
	uiRet = DSTP2x_Lbl_DrawLine(labelHdl, 5, 45, 90, 55, 15, 2); //Dot line
	uiRet = DSTP2x_Lbl_DrawLine(labelHdl, 5, 65, 90, 75, 15, 3); //Dash dot line
	uiRet = DSTP2x_Lbl_DrawLine(labelHdl, 5, 85, 90, 95, 15, 4); //Dash double dot line
