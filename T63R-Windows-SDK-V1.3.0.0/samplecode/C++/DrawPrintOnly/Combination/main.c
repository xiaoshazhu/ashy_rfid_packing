...
int main(int argc, char *argv[])
{
	...
	const char *szImagePath = "../../../DrawPrintOnly/Combination/image.jpg";
	...
	uiRet = DSTP2x_CreateLabelContext(50, 100, &labelHdl);
	if (uiRet)
	{
	...
	//6.Draw bar code.
	uiRet = DSTP2x_Lbl_DrawBarCode(labelHdl, 0, 60, 40, 30, 20, "123456");//data must be utf-8
	if(uiRet)
	{
	...
	//7.Set font name of text.
	uiRet = DSTP2x_LcDraw_SetTextFontName(labelHdl, 1, "Arial"); //The font name must be utf-8
	if(uiRet)
	{
	...
	//8.Draw text.
	uiRet = DSTP2x_Lbl_DrawText(labelHdl, 0, 0, 40, 20, "abcdef123456");
	if(uiRet)
	{
